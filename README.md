...
**409 unit and integration tests** (`pytest tests/`), covering ball-state classification,
...
```bash
pip install -e ".[dev]"
pytest tests/                                       # 409 tests, needs the weights
pytest tests/ -m "not slow"                         # 408, what CI runs, no weights
...
tests/                409 unit and integration tests
